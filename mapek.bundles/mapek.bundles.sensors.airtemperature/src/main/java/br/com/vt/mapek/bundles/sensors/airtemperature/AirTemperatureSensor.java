...
@Component
@Provides(specifications = IAirTemperatureSensor.class)
@Instantiate
public class AirTemperatureSensor extends ABSensor implements
		IAirTemperatureSensor, SensorEventListener {
